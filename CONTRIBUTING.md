# Contributing to cuioss Projects
...
- We have the necessary rights to distribute the code under the project's license
...
Please do not report security vulnerabilities through public GitHub issues. Use GitHub's private vulnerability reporting feature instead. See [SECURITY.md](SECURITY.md) for details.
...
Most cuioss projects use Maven. Before committing:
...
Both builds must pass without errors before committing.
...
By contributing, you agree that your contribution will be published under the project's license (typically Apache License 2.0).
